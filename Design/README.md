...
Возможные ошибки:
1) Переданные файлы не найдены - `example_file: No such file or directory`
2) Файл нельзя открыть для чтения - `example_file: Permission denied`
...
Возможные ошибки: 
1) Не было передано ни одного файла - `No files were provided`
2) Переданные файлы не найдены - `example_file: No such file or directory`
3) Файл нельзя открыть для чтения - `example_file: Permission denied`
